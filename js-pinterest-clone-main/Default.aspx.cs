...
namespace WebApplication1
{
    public partial class _Default : Page
    {
        ...
        public SqlConnection dbconn()
        {
            ...
            connetionString = "Data Source=172.16.12.14;Initial Catalog=Sai_guvi;User Id=training1;Password=Karomi@123";
        ...
        protected void check_login2(object sender, EventArgs e)
        {
            ...
            {
                Response.Redirect("https://localhost:44352/js-pinterest-clone-main/index.html");
            }
            else
            {
                Response.Redirect("https://localhost:44352/js-pinterest-clone-main/index.html");
